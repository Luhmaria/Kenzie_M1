...
let dinheiro = parseFloat(prompt('Quanto em dinheiro você deseja comprar de gasolina?'))
...
// alert(`O valor ${temperaturaFahrenheit}ºf em Celsius é ${temperaturaCelsius}ºC.`)
...
// alert(`A soma dos valores informados é: ${somaNotas} e a média das notas é: ${mediaNotas}`)

//7
// let numero1 = parseInt(prompt('Digite um número inteiro positivo que será dividido'))
// let numero2 = parseInt(prompt('Digite um número inteiro positivo que será o divisor'))
