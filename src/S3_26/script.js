...
if (mediaNota >= 8 && presença >= 6) {
  alert(
    `A nota do aluno ${nomeAluno} é de ${mediaNota} e sua presença ${presença}: Aluno Aprovado!`
  );
} else {
  alert(
    `A nota do aluno ${nomeAluno} é de ${mediaNota} e sua presença ${presença}: Aluno Reprovado!`
  );
}
