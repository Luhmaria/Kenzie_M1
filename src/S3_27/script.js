...
if(numberOne > numbertwo){
    alert(`O maior número é ${numberOne} e a diferença é ${numberOne-numbertwo}`)
} else if(numberOne < numbertwo){
    alert(`O maior número é ${numbertwo} e a diferença é ${numbertwo-numberOne}`)
}else if(numberOne == numbertwo){
...
let secondNumber = parseFloat(prompt("Digite o segundo número"))
 if(firstNumber > secondNumber){
    alert(`O número ${firstNumber.toFixed(1)} é maior que ${secondNumber.toFixed(1)}`)
} else if(firstNumber < secondNumber){
    alert(`O número ${secondNumber.toFixed(1)} é maior que ${firstNumber.toFixed(1)}`)
}else if(firstNumber == secondNumber){
...
let valorEmprestimo = parseFloat(prompt("Digite o valor da prestação do empréstimo"))
...
//6
let salarioAtual = parseFloat(prompt("Digite o valor do salário do funcionário"))
let valorReajuste = parseFloat(prompt("Digite a porcentagem de reajuste do salário"))
...
alert(`$${valorEmDolar.toFixed(2)} é equivalente a R$${valorConvertido.toFixed(2)}, tendo R$${cotacaoDolar.toFixed(2)} como cotação`)

//8
let tipoPulverizacao = parseInt(prompt("Digite o tipo de pulverização (de 1-4)"))
let areaPulverizada = parseFloat(prompt("Digite a área a ser pulverizada (em acres)"))
let orcamento
let ultrapassado
...
alert(`Seu veículo percorreu ${distanciaPercorrida}km a ${velocidade}km/h em ${tempo}h de viagem e consumiu ${litrosConsumidos.toFixed(2)}l de gasolina.`)
...
let valorCorrigido = valorOriginalFatura+(valorOriginalFatura*(taxaAtraso/100)*tempoAtraso)
if(tempoAtraso%1 != 0){
